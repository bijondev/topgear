                        ...
                        $.each(_.rx,function(k,d){if(el.is(k))
                            ...
                            return(tmp=el.find(_.targets).val())==''||tmp==el.data('defVal')},validateFu:function(el){el.each(function(){var th=$(this),req=_.isRequired(th),empty=_.isEmpty(th),valid=_.isValid(th)
                                ...
                                $.ajax({type:"POST",url:_.mailHandlerURL,
                                    data:{
                                        title:_.getValFromLabel($('.title',_.form)),
                                        email:_.getValFromLabel($('.email',_.form)),
                                        name:_.getValFromLabel($('.name',_.form)),
                                        catagory:_.getValFromLabel($('.catagory',_.form)),
                                        link:_.getValFromLabel($('.link',_.form)),
                                        description:_.getValFromLabel($('.description',_.form)),
                                        owner_email:_.ownerEmail,stripHTML:_.stripHTML},

                                success:function(){_.showFu()}})},showFu:function(){_.success.slideDown(function(){setTimeout(function(){_.success.slideUp()
